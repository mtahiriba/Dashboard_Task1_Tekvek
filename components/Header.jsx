...
const Header = () => {
  return (
    <div className="h-[12%] shadow-lg flex items-center justify-between border-b border-gray-400">
      <div className="flex">
        <div className="bg-green-500 pt-3 pb-3 pr-3 pl-1 rounded-r-md cursor-pointer mr-12">
          <svg
      ...
      <div className=" mr-5 flex gap-10">
        <div className="flex gap-3 items-center text-gray-500 text-sm cursor-pointer">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
